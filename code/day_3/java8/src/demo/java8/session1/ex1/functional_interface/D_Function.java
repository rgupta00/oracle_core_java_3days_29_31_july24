...
public class D_Function {
    public static void main(String[] args) {
    	...
    	Function<Emp, String>f1=emp-> emp.getName();
    	
    	Emp e1=new Emp(1, "raja", 340000);
    	
   
//    	String name=f1.apply(e1);
//    	
//    	System.out.println(name);
    	...
    	Function<Emp, EmpData> f2=(Emp e) ->new EmpData(e.getId(), e.getSalary());
		
    	BiFunction<String, String, String> f3=(fn, ln)->fn.concat(ln);
    	
		System.out.println(f3.apply("rajiv" , " gupta"));
